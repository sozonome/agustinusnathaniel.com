...
___
Build with [Gatsby](https://gatsbyjs.org "One of the coolest React Framework") + [SASS](https://sass-lang.com/ "Great CSS Pre-processors") + [Typescript](https://www.typescriptlang.org/ "Well, I prefer to write in Typescript") 💪

and also [Semantic-UI-React](https://react.semantic-ui.com/ "Bored with Bootstrap")
