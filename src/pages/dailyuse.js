  ...
  return (
    <Layout>
      ...
      <p className="text-lg font-semibold mb-6">
        List of stuffs I currently use on daily basis.
      </p>
      <section id="tech" className="mb-6">
        ...
        <ul className="list-disc px-5">
          <li>
            <a
              href="https://www.asus.com/Laptops/ROG-GL552VW/"
              className="text-indigo-400 hover:text-indigo-200 hover:underline hover:font-bold"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.logitech.com/id-id/product/m170-m171-wireless-mouse"
              className="text-indigo-400 hover:text-indigo-200 hover:underline hover:font-bold"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <ul className="list-disc px-5">
          <li>
            <a
              ...
              className="text-green-400 hover:text-green-200 hover:underline hover:font-bold"
              target="_blank"
              rel="noopener noreferrer"
            >
              Evernote
          ...
          <li>
            <a
              href="https://www.google.com/calendar/about/"
              className="text-green-400 hover:text-green-200 hover:underline hover:font-bold"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <section id="sitestack">
        ...
        <Link
          ...
          className="text-green-400 hover:text-green-200 hover:underline hover:font-bold"
        >
          Wanna know which stacks I use to build this site?
        </Link>
      </section>
    </Layout>
  )
